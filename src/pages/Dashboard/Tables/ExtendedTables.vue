...
export default {
  data() {
    return {
      ...
      shoppingCartTable: [
        {
          image: process.env.VUE_APP_BASE_URL + "/img/product1.jpg",
        ...
        {
          image: process.env.VUE_APP_BASE_URL + "/img/product2.jpg",
          product: "Short Pants",
          category: "by Gucci",
          color: "Purple",
          size: "M",
        ...
        {
          image: process.env.VUE_APP_BASE_URL + "/img/product3.jpg",
